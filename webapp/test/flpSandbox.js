		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bank Approver",
									"targetURL": "#comsapbankapproverapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapbankapproverapp-display": {
								"semanticObject": "comsapbankapproverapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.bankapproverapp",
									"url": sap.ui.require.toUrl("com/sap/bankapproverapp")
								}
							}
						}
					}
